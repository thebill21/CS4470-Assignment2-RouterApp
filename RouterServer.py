...
class Router:
    def __init__(self, server_id, update_interval, topology_file):
        ...
        self.update_needed = False  # Prevent unnecessary updates
    ...
    def send_update(self):
        ...
        if not self.update_needed:
            return  # Only send updates when needed
        ...
        self.update_needed = False  # Reset flag after sending updates
    ...
    def process_update_message(self, message):
        ...
        # If the table was updated, mark update as needed
        if updated:
